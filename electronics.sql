...
INSERT INTO `cache_tags` VALUES ('asset_1','asset_1'),('asset_2','asset_2'),('asset_3','asset_3'),('object_8','asset_3'),('object_9','asset_3'),('asset_4','asset_4'),('asset_5','asset_5'),('object_15','asset_5'),('object_11','class_brand'),('object_14','class_brand'),('object_12','class_category'),('object_13','class_category'),('object_8','class_category'),('object_15','class_product'),('object_9','class_product'),('document_1','document_1'),('document_properties_1','document_1'),('document_properties_1','document_properties'),('object_1','object_1'),('object_10','object_10'),('object_11','object_11'),('object_12','object_12'),('object_13','object_13'),('object_14','object_14'),('object_15','object_15'),('object_3','object_3'),('object_4','object_4'),('object_8','object_8'),('object_9','object_9'),('system_route_redirect','redirect'),('system_resource_columns_edit_lock','resource'),('system_resource_columns_users','resource'),('system_resource_columns_users_workspaces_asset','resource'),('system_resource_columns_users_workspaces_object','resource'),('system_route_redirect','route'),('site_domain_ef3d53ccb1590e6c44140f57feae89c9','site'),('site_domain_ef3d53ccb1590e6c44140f57feae89c9','system'),('system_resource_columns_edit_lock','system'),('system_resource_columns_users','system'),('system_resource_columns_users_workspaces_asset','system'),('system_resource_columns_users_workspaces_object','system'),('system_route_redirect','system'),('system_supported_locales_en','system'),('translation_data_admin_en','translate'),('translation_data_admin_en','translator'),('translation_data_admin_en','translator_website');
...
INSERT INTO `dependencies` VALUES (1,'object',8,'asset',3),(3,'object',9,'asset',3),(2,'object',9,'object',8),(5,'object',15,'asset',5),(4,'object',15,'object',8);
...
INSERT INTO `edit_lock` VALUES (48,11,'object',2,'7eefgd5aricpnqkpieedh1nbsg',1617338316),(52,10,'object',2,'pd7mqurt7d0rd7esbo7gegcuat',1617365079),(53,4,'object',2,'pd7mqurt7d0rd7esbo7gegcuat',1617365087),(57,14,'object',2,'pd7mqurt7d0rd7esbo7gegcuat',1617365475),(60,9,'object',2,'pd7mqurt7d0rd7esbo7gegcuat',1617367335),(61,2,'asset',2,'pd7mqurt7d0rd7esbo7gegcuat',1617367452),(62,3,'asset',2,'pd7mqurt7d0rd7esbo7gegcuat',1617367460);
...
INSERT INTO `object_query_brand` VALUES (11,'brand','brand','LG'),(14,'brand','brand','Samsung');
...
INSERT INTO `object_query_category` VALUES (8,'category','category','AC','A system for controlling the humidity, ventilation, and temperature in a building or vehicle, typically to maintain a cool atmosphere in warm conditions.',3,1),(12,'category','category','Fan',NULL,NULL,NULL),(13,'category','category','Refrigerator',NULL,NULL,NULL);
...
INSERT INTO `object_query_product` VALUES (9,'product','product','LG','abc','LG 1.5 Ton 5-Star Inverter Split AC – KS-Q18YNZA',8,'object',101,'rupees',5,'fd0808','ff',3,100,'kg','5 Star',1,'volts',1,'watt',1617388200),(15,'product','product','LG','2345','Lg sony Ac',8,'object',20000,NULL,3,'9c3939','ff',5,3,'kg','4 Star',220,NULL,1.5,NULL,1617561000);
...
INSERT INTO `object_relations_product` VALUES (4,9,8,'object','category',0,'object','','0'),(5,15,8,'object','category',0,'object','','0');
...
INSERT INTO `object_store_brand` VALUES (11,'LG'),(14,'Samsung');
...
INSERT INTO `object_store_category` VALUES (8,'AC','A system for controlling the humidity, ventilation, and temperature in a building or vehicle, typically to maintain a cool atmosphere in warm conditions.',3,1),(12,'Fan',NULL,NULL,NULL),(13,'Refrigerator',NULL,NULL,NULL);
...
INSERT INTO `object_store_product` VALUES (9,'LG','abc','LG 1.5 Ton 5-Star Inverter Split AC – KS-Q18YNZA',101,'rupees',5,'fd0808','ff',3,100,'kg','5 Star',1,'volts',1,'watt',1617388200),(15,'LG','2345','Lg sony Ac',20000,NULL,3,'9c3939','ff',5,3,'kg','4 Star',220,NULL,1.5,NULL,1617561000);
...
INSERT INTO `quantityvalue_units` VALUES ('dollar',NULL,'$',NULL,NULL,NULL,NULL,NULL,''),('gm',NULL,'g',NULL,NULL,NULL,NULL,NULL,''),('kg',NULL,'kg',NULL,NULL,NULL,NULL,NULL,''),('rupees',NULL,'Rs',NULL,NULL,NULL,NULL,NULL,''),('ton',NULL,'ton ',NULL,NULL,NULL,NULL,NULL,''),('volts',NULL,'V',NULL,NULL,NULL,NULL,NULL,''),('watt',NULL,'W',NULL,NULL,NULL,NULL,NULL,'');
...
/*!50013 DEFINER=`task`@`localhost` SQL SECURITY DEFINER */
...
-- Dump completed on 2021-04-04 10:43:35
